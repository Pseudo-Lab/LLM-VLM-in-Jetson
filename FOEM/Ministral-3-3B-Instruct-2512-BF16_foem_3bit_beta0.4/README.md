# Ministral-3-3B-Instruct-2512-BF16_foem_3bit_beta0.4

> 생성일: 2026-07-08 05:34
...
ΔW = -e_i ⊗ H⁻¹[i,:]            ← ① 기본 GPTQ 항
     - (W - W_fp) · H⁻² · β     ← ② FOEM 직접 오차 피드백 (β=0.4)
```
...
model = GPTQModel.from_quantized("/workspace/LLM-VLM-in-Jetson/Ministral-3-3B-Instruct-2512-BF16_foem_3bit_beta0.4")
```
