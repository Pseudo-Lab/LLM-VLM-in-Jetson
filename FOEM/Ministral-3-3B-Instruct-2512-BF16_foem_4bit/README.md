# Ministral-3-3B-Instruct-2512-BF16_foem_4bit

> 생성일: 2026-07-08 06:59
...
model = GPTQModel.from_quantized("/workspace/LLM-VLM-in-Jetson/FOEM/Ministral-3-3B-Instruct-2512-BF16_foem_4bit")
```
