# Ministral-3-3B-Instruct-2512-BF16_foem_3bit_gs64

> 생성일: 2026-07-08 05:56
...
| 실제 모델 파일 크기 | 2.90 GB |
| 실질 압축률 | **0.0×** |
| group_size=64 오버헤드 | ~0 MB (scale+zero 파라미터) |
...
model = GPTQModel.from_quantized("/workspace/LLM-VLM-in-Jetson/Ministral-3-3B-Instruct-2512-BF16_foem_3bit_gs64")
```
...
| 파일 | 설명 |
|---|---|
| `model.safetensors` | 양자화된 가중치 (2.9 GB) |
