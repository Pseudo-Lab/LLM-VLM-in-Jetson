# Ministral-3-3B-Instruct-2512-BF16_foem_3bit_alpha0.3

> 생성일: 2026-07-08 05:05
...
model = GPTQModel.from_quantized("/workspace/LLM-VLM-in-Jetson/Ministral-3-3B-Instruct-2512-BF16_foem_3bit_alpha0.3")
```
